...
export const personalInfo: PersonalInfo = {
  ...
  bio: {
    ...
    zh: '[vivo](https://www.vivo.com.cn/)影像算法工程师，主要从事多模态大语言模型（MLLM）的前沿预研与端侧部署。核心工作包括基于LLM的自动化数据工程、端侧模型部署，以及探索Agentic工作流。此前于深圳大学攻读硕士学位，在[王旭教授](https://csse.szu.edu.cn/pages/user/index?id=556)的指导下，专注于3D高斯泼溅（3DGS）的高效编码与传输。我热衷于将最先进的算法与实际业务场景相结合。',
  },
  avatar: '',
};
